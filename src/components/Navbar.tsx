...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-x-0 border-t-0 rounded-none"
    >
      ...
      {mobileOpen && (
        <motion.div
          ...
          className="md:hidden glass-card border-t rounded-none px-4 py-4 space-y-2"
        >
          {navLinks.map((link) => (
            <Link
              key={link.path}
